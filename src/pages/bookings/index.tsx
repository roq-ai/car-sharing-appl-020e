...
export function BookingListPage(props: BookingListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBookings({
        ...
        order: params.order,
        searchTermKeys: ['pickup_location.contains', 'dropoff_location.contains', 'booking_status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'booking_status', header: 'Booking Status', accessorKey: 'booking_status' },
