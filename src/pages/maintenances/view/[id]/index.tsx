...
import { getMaintenanceById } from 'apiSdk/maintenances';
import { MaintenanceInterface } from 'interfaces/maintenance';

function MaintenanceViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('maintenance', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/maintenances/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={
                    data?.maintenance_date
                      ? format(parseISO(data?.maintenance_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem label="Cost" text={data?.cost} />

                <FormListItem label="Maintenance Status" text={data?.maintenance_status} />
