...
export function CarListPage(props: CarListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCars({
        relations: ['company', 'booking.count', 'maintenance.count', 'review.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['model.contains', 'manufacturer.contains', 'color.contains', 'registration_number.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'year_of_manufacture', header: 'year_of_manufacture', accessorKey: 'year_of_manufacture' },
    { id: 'color', header: 'Color', accessorKey: 'color' },
    { id: 'registration_number', header: 'Registration Number', accessorKey: 'registration_number' },
