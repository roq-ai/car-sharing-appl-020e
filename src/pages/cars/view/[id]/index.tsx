...
import { MaintenanceListPage } from 'pages/maintenances';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Year Of Manufacture" text={data?.year_of_manufacture} />

                <FormListItem label="Color" text={data?.color} />

                <FormListItem label="Registration Number" text={data?.registration_number} />
